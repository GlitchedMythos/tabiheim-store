/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 2823cc5d5298b0eb3b5438691c8b9d55)
// Runtime types generated with workerd@1.20251011.0 2025-02-04 nodejs_compat
...
interface Scheduler {
  wait(
    delay: number,
    maybeOptions?: SchedulerWaitOptions
  ): Promise<void>;
}
...
declare class File extends Blob {
  constructor(
    bits:
      | ((ArrayBuffer | ArrayBufferView) | string | Blob)[]
      | undefined,
    name: string,
    options?: FileOptions
  );
...
> = Fetcher<T> &
  (T extends CloudflareWorkersModule.WorkerEntrypoint<
    any,
    infer Props
  >
...
type Ai_Cf_Openai_Gpt_Oss_120B_Output =
  | {}
  | (string & NonNullable<unknown>);
...
interface IncomingRequestCfPropertiesCloudflareForSaaSEnterprise<
  HostMetadata
> {
  /**
